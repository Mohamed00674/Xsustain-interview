...
import { createItem, getItems, getItemById, updateItem, deleteItem, addRating, removeRating } from '../controllers/itemController.js';
...
itemRoutes.post('/', authenticate, validateItem, upload.single('image'), validateRequest, createItem);
